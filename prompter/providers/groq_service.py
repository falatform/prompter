class GroqService:
    """
    Groq provider (fast Llama, etc.).

    Args:
        api_key (str): Your Groq API key.
        model (str): Model name, e.g. 'llama-3-70b'.
        temperature (float, optional): Sampling temperature.
        max_tokens (int, optional): Maximum tokens in output.

    Example:
        GroqService(api_key="...", model="llama-3-70b")
    """
    def __init__(self, api_key, model="llama-3-70b", temperature=0.7, max_tokens=1024):
    ...
    def generate(
        ...
        **kwargs
        ...
        api_url = f"https://api.groq.com/v1/generate"
