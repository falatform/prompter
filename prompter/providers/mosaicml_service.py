class MosaicMLService:
    """
    Databricks MosaicML provider.

    Args:
        api_key (str): Your MosaicML API key.
        model (str): Model name.
        temperature (float, optional): Sampling temperature.
        max_tokens (int, optional): Maximum tokens in output.

    Example:
        MosaicMLService(api_key="...", model="mpt-7b-chat")
    """
    ...
    def generate(
        ...
        **kwargs
        ...
        """
        Generate a response from MosaicML.
        ...
        api_url = f"https://api.mosaicml.com/v1/generate"
