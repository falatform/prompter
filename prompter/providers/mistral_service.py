class MistralService:
    ...
    Args:
        ...
        model (str): Model name, e.g. 'mistral-large'.
        temperature (float, optional): Sampling temperature.
        max_tokens (int, optional): Maximum tokens in output.

    Example:
        MistralService(api_key="...", model="mistral-large")
    """
    def __init__(self, api_key, model="mistral-large", temperature=0.7, max_tokens=1024):
    ...
    def generate(
        ...
        **kwargs
        ...
        api_url = f"https://api.mistral.ai/v1/generate"
